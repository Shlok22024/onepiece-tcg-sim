...
- The engine now owns a simple turn loop with explicit phases, phase advancement, placeholder DON handling, phase-aware action legality, and basic Character card play.
...
Engine and rules services
  -> own GameState, phase validation, DON placeholders, cost payment, and immutable state transitions
...
src/engine    Source-of-truth game state, phase flow, actions, cost helpers, logs, errors, and transition helpers
